...
public class Utility4 extends UtilityWrapper
{
	...
	{
		if (text != null) { return text.toString().toUpperCase(); }
		return null;
	}
	
	@Override
	public PopupWindow buildPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
	{
	...
	{
		/*kkif(l instanceof IcsLinearLayout) {
	...
	{
		/*kk if(l instanceof IcsLinearLayout) {
