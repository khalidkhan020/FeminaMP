 ...
 * <br/>
 * 1) Month title view: show the month and year (e.g MARCH, 2013) <br/>la
 * <br/>
...
public class CaldroidFragment extends DialogFragment
{
	...
	public boolean								backbar_needed					= true;
	/**
	...
	private ImageButton							backbuButton;
	...
	public final static String					BACKBAR_NEEDED					= "backbar_needed";
	/**
	 * For internal use
	 */
	...
	public void setBackgroundResourceForDates(HashMap<Date, Integer> backgroundForDateMap)
	{
		...
		if (backgroundForDateMap == null || backgroundForDateMap.size() == 0) { return; }
	...
	public void setTextColorForDates(HashMap<Date, Integer> textColorForDateMap)
	{
		...
		if (textColorForDateMap == null || textColorForDateMap.size() == 0) { return; }
	...
	{
		disableDates.clear();
		if (disableDateList == null || disableDateList.size() == 0) { return; }
	...
	{
		disableDates.clear();
		if (disableDateStrings == null) { return; }
	...
	private OnItemClickListener getDateItemClickListener()
	{
		dateItemClickListener = new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (caldroidListener != null)
				{
					if ((minDateTime != null && dateTime.isBefore(minDateTime)) || (maxDateTime != null && dateTime.isAfter(maxDateTime)) || (disableDates != null && disableDates.indexOf(dateTime) != -1)) { return; }
	...
	private OnItemLongClickListener getDateOnItemLongClickListener()
	{
		onItemLongClickListener = new OnItemLongClickListener()
		{
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
			{
				...
				DateTime dateTime = dateInMonthsList.get(arg2);
				if (caldroidListener != null)
				{
					if ((minDateTime != null && dateTime.isBefore(minDateTime)) || (maxDateTime != null && dateTime.isAfter(maxDateTime)) || (disableDates != null && disableDates.indexOf(dateTime) != -1)) { return true; }
					
					caldroidListener.onLongSelectDate(arg1, dateTime.toDate());
				}
				return true;
			}
		};
	...
	public void refreshView()
	{
		...
		monthTitleTextView.setText(new DateTime(year, month, 1, 0, 0, 0, 0).monthOfYear().getAsText().toUpperCase() + " " + year);
	...
	private void retrieveInitialArgs(Bundle savedInstanceState)
	{
		...
		if (args != null)
		{
			...
			startDayOfWeek = args.getInt(START_DAY_OF_WEEK, DateTimeConstants.SUNDAY);
			if (startDayOfWeek > 7)
			{
			...
			forward = args.getInt(FORWARD);
			backbar_needed = args.getBoolean(BACKBAR_NEEDED, true);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		if (t != null)
		{
			t.applyBackgroundColor(R.id.weekday_gridview, "text_color");
			t.applyTextColor(R.id.calendar_month_year_textview, "heading_fg");
			t.applyBackgroundDrawable(R.id.nav, "mpt_cal_nav");
			t.applyBackgroundDrawable(R.id.content, "heading_bg");
			t.applyBackgroundColor(R.id.months_infinite_pager, "text_color");
			
		}
		// For the monthTitleTextView
		monthTitleTextView = (TextView) view.findViewById(R.id.calendar_month_year_textview);
		BackBar backBar = (BackBar) view.findViewById(R.id.calendarbackbutton);
		...
		backBar.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				// TODO Auto-generated method stub
				getActivity().finish();
				APP.GLOBAL().exicuteRIOAnim(getActivity());
				//getActivity().overridePendingTransition(R.anim.right_in, R.anim.right_out);
			}
		});
		if (backbar_needed) backBar.setVisibility(View.VISIBLE);
		else backBar.setVisibility(View.GONE);
		...
		WeekdayBaseAdptor weekdayBaseAdptor = new WeekdayBaseAdptor(getActivity(), getDaysOfWeek());
		weekdayGridView.setAdapter(weekdayBaseAdptor);
	...
	private void setupDateGridPages(View view)
	{
		...
		for (int i = 0; i < NUMBER_OF_PAGES; i++)
		{
			...
			dateGridFragment.setOnItemLongClickListener(getDateOnItemLongClickListener());
		}
