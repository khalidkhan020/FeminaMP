...
public class SettingsAdaptor extends BaseAdapter
{
	
	String[]	strings;	SimpleDateFormat					dateFormat;
	Context		context;
	String		className;
	
	public SettingsAdaptor(Context context, String[] strings2)
	{
	...
	public View getView(int arg0, View convertView, ViewGroup arg2)
	{
		...
		else if (strings[arg0].equals(context.getString(R.string.setstartdate)))
		{
			textView2.setText(context.getString(R.string.enterPeriodLog));
			
			imageviView.setText(APP.GLOBAL().getPreferences().getString(APP.PREF.START_DATE.key, ""));
		}
		else if (strings[arg0].equals(context.getString(R.string.setenddate)))
		{
			textView2.setText(context.getString(R.string.periodenddate));
			if(!APP.GLOBAL().getPreferences().getString(APP.PREF.END_DATE.key, "").equals(dateFormat.format(PeriodTrackerConstants.NULL_DATE)))
			imageviView.setText(APP.GLOBAL().getPreferences().getString(APP.PREF.END_DATE.key, ""));
			else
				imageviView.setText("");
		}
